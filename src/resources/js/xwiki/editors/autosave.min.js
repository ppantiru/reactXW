...
0<b?(this.options.frequency=b,this.setTimeUnit(),this.startTimer()):this.autosaveInput.value=this.options.frequency;this.autosaveInput.removeClassName("focused")}.bindAsEventListener(this));Event.observe(this.autosaveInput,"focus",function(){this.autosaveInput.addClassName("focused")}.bindAsEventListener(this));this._toggleTimerWhenSaveButtonIsEnabledOrDisabled()},setTimeUnit:function(){1==this.options.frequency?this.timeUnit.update("minute"):this.timeUnit.update("minutes")},_toggleTimerWhenSaveButtonIsEnabledOrDisabled:function(){var a=
this,b=new MutationObserver(function(g){g.forEach(function(h){h.target.disabled?a.stopTimer():a.toggleTimer()})}),c=this.form.down('input[name="action_saveandcontinue"]');b.observe(c,{attributes:!0,attributeFilter:["disabled"]})},toggleTimer:function(a){"boolean"===typeof a&&(this.options.enabled=a);this.options.enabled?(this.startTimer(),this.autosaveInput&&this.autosaveInput.up("label").setOpacity("1.0")):(this.stopTimer(),this.autosaveInput&&this.autosaveInput.up("label").setOpacity(this.options.disabledOpacity))},
startTimer:function(){this.stopTimer();this.timer=new PeriodicalExecuter(this.doAutosave.bind(this),60*this.options.frequency)},stopTimer:function(){this.timer&&(this.timer.stop(),delete this.timer)},doAutosave:function(){this.updateVersionMetadata();try{this.form.down('input[name="action_saveandcontinue"]').click()}finally{this.resetVersionMetadata()}},updateVersionMetadata:function(){this.customMetadataElementsContainer&&this.form.insert(this.customMetadataElementsContainer);this.userEditComment=
this.editComment.value;this.userMinorEdit=this.minorEditCheckbox.checked;this.editComment.value+=" (Autosaved)";this.minorEditCheckbox.checked=!0},resetVersionMetadata:function(){this.customMetadataElementsContainer&&this.customMetadataElementsContainer.remove();this.editComment.value=this.userEditComment;this.minorEditCheckbox.checked=this.userMinorEdit}});d.domIsLoaded&&e()||document.observe("xwiki:dom:loaded",e);return d}(XWiki||{});
