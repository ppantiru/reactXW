...
addAddButton:function(){var a=new Element("input",{type:"button",value:d["core.viewers.attachments.upload.addFileInput"],className:"attachmentActionButton add-file-input"});this.addDiv=new Element("div");this.addDiv.appendChild(a);Event.observe(a,"click",this.addField.bindAsEventListener(this));this.defaultFileDiv.up().insertBefore(this.addDiv,this.defaultFileDiv.next())},blockEmptySubmit:function(){Event.observe(this.form,"submit",this.onSubmit.bindAsEventListener(this))},resetOnCancel:function(){Event.observe(this.form,
"reset",this.onReset.bindAsEventListener(this));Event.observe(this.form.down(".cancel"),"click",this.onReset.bindAsEventListener(this))},addField:function(a){var c=new Element("input",{type:"file",name:"filepath_"+this.counter,size:this.inputSize,className:"uploadFileInput"}),b=new Element("input",{type:"hidden",name:"filename_"+this.counter}),e=this.createRemoveButton(),g=new Element("div",{"class":"fileupload-field"});g.insert(b).insert(c).insert(e);this.addDiv.parentNode.insertBefore(g,this.addDiv);
a.element().blur();this.counter++},removeField:function(a){a.element().up("div").remove()},createRemoveButton:function(){var a=new Element("input",{type:"button",value:d["core.viewers.attachments.upload.removeFileInput"],title:d["core.viewers.attachments.upload.removeFileInput.title"],className:"attachmentActionButton remove-file-input"});Event.observe(a,"click",this.removeField.bindAsEventListener(this));return a},onSubmit:function(a){var c=!1;this.form.getInputs("file").each(function(b){""!=b.value&&
...
"#deleteAttachment",function(b){a(this).data("relatedTarget",a(b.relatedTarget))});a(document).on("click","#deleteAttachment input.btn-danger",function(){var b=a("#deleteAttachment").data("relatedTarget"),e;a.ajax({url:b.prop("href"),beforeSend:function(){b.prop("disabled",!0);e=new XWiki.widgets.Notification(d["core.viewers.attachments.delete.inProgress"],"inprogress")},success:function(){b.closest(".attachment").remove();c();e.replace(new XWiki.widgets.Notification(d["core.viewers.attachments.delete.done"],
"done"))},error:function(){b.prop("disabled",!1);e.replace(new XWiki.widgets.Notification(d["core.viewers.attachments.delete.failed"],"error"))}})});var c=function(){var b=a("#Attachmentstab").find(".itemCount"),e=a("#Attachmentspane .attachment").size();b&&b.text(d["docextra.extranb"].replace("__number__",e));a("#tmAttachments").length&&(a("#tmAttachments")[0].normalize(),b=" "+d["docextra.attachments"]+" "+d["docextra.extranb"],b=b.replace("__number__",e),a("#tmAttachments").contents().last()[0].nodeValue=
b)};a(document).on("xwiki:html5upload:done",function(){c()})})}).apply("]]#",$jsontool.serialize([$l10n]));
