...
function(h,d){h=b(d&&d.elements||document);h.find(".suggest-users").suggestUsers();h.find(".suggest-groups").suggestGroups()};b(document).on("xwiki:dom:updated",k);b(k)})}).apply("]]#",$jsontool.serialize([$paths]));
