...
d.OutdatedExtensionsStep=Class.create(g,{_enable:function(){var a=this.container.down(".checkForUpdates");a&&a.up(".xHint").show()},_disable:function(){var a=this.container.down(".checkForUpdates");a&&a.up(".xHint").hide()},_isCompleted:function(){var a=0,b=0;this.container.select(".invalidExtensions").each(function(c){c=c.childElements();a+=c.size();b+=c.filter(function(e){return e.hasClassName("extension-item-installed")}).size()});return b==a}});var k=Class.create(g,{_isCompleted:function(){return!0}}),
