'use strict';var LiveValidation=Class.create();Object.extend(LiveValidation,{VERSION:"1.4 prototype",TEXTAREA:1,TEXT:2,PASSWORD:3,CHECKBOX:4,SELECT:5,FILE:6,massValidate:function(b){for(var a=!0,c=0,e=b.length;c<e;++c){var d=b[c].validate();a&&(a=d)}return a}});
