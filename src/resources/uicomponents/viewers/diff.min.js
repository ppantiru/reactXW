...
b(document).trigger("xwiki:dom:updated",{elements:e.toArray()})})}f=b(c.target).data("hint");b(c.target).closest(".changes-body-header").find(".changes-actions").removeClass("active").filter("."+f).addClass("active")})},r=function(){var a=b(this).next("ul");0<a.size()&&(a.hide(),b(this).find("a").click(function(c){c.preventDefault();a.toggle()}))},k=function(a){var c=b(a).prev();if(0<c.length)return c[0];a=b(a).parent();if(0<a.length)return k(a[0])},l=function(a){var c=b(a).next();if(0<c.length)return c[0];
a=b(a).parent();if(0<a.length)return l(a[0])},h=function(a,c){"true"===b(a).attr("data-xwiki-html-diff-hidden")&&b(a).attr({"data-xwiki-html-diff-hidden":"ellipsis","data-xwiki-html-diff-expand":c?"up":"down"})},n=function(a){a.find("[data-xwiki-html-diff-hidden]").attr("data-xwiki-html-diff-hidden",!0);a.find("[data-xwiki-html-diff-block]").each(function(){h(k(this),!0);h(l(this),!1)})},t=function(a){a.find(".html-diff-context-toggle").click(function(c){c.preventDefault();c=b(this);var e=c.closest(".changes-body").find(".html-diff");
