...
e)});b.DocumentLock._instances[b.Model.serialize(this._document.documentReference)]=this},lock:function(){this._locked||(this._locked=!0,new Ajax.Request(this._getURL("lock"),{method:"get"}))},unlock:function(){this._locked&&(this._locked=!1,"function"===typeof navigator.sendBeacon?navigator.sendBeacon(this._getURL("cancel")):new Ajax.Request(this._getURL("cancel"),{method:"get",asynchronous:!1}))},setLocked:function(a){this._locked=!!a},isLocked:function(){return this._locked},_getURL:function(a){return this._document.getURL(a,
"ajax=1&action="+b.contextaction+"&"+(b.docvariant||""))}});b.DocumentLock._instances={};b.DocumentLock.get=function(a){a=c(a);a=new b.DocumentReference(a.wiki,a.space,a.page);return b.DocumentLock._instances[b.Model.serialize(a)]};var d=function(){b.EditLock=new b.DocumentLock;b.EditLock.lock();return!0};b.domIsLoaded&&d()||document.observe("xwiki:dom:loaded",d);return b}(XWiki||{});
